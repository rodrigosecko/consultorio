            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Unidades de la Empresa</h4>                                        
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_table_unidad as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row->padre_unidad; ?></td>                                                      
                                                    <td>                                           
                                                        <?php if (($row->activo)==1):?>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('unidad/edit'); ?>/<?php echo $row->unidad_id; ?>"><button type="button" class="btn btn-warning"><span class="fas fa-edit" aria-hidden="true"></span></button></a>
                                                        <?php if (($row->nivel)!=1):?>

                                                        <?php if (($row->activo)==1):?>
                                                            <a href="<?php echo site_url('unidad/delete'); ?>/<?php echo $row->unidad_id; ?>"><button type="button" class="btn btn-danger"><span class="fas fa-arrow-alt-circle-down" aria-hidden="true"></span> Dar de Baja</button></a>
                                                        <?php endif ?>
                                                        <?php if (($row->activo)==0):?>
                                                            <a href="<?php echo site_url('unidad/delete'); ?>/<?php echo $row->unidad_id; ?>"><button type="button" class="btn btn-success"><span class="fas fa-arrow-alt-circle-up" aria-hidden="true"></span> Dar de Alta</button></a>
                                                        <?php endif ?>
                                                         <?php endif ?>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" id="exampleModalLabel1">Unidades de la empresa</h4>
                                </div>
                                <div class="modal-body">
                                    <!--<form action="<?php echo base_url();?>zona_urbana/insertar" method="POST">-->
                                        <?php echo form_open('unidad/create'); ?>
