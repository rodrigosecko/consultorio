            ...
            <div class="col-12">
                <div class="card wizard-content">
                    <div class="card-body">
                        ...
                        <div class="row" >
                            <div class="col-md-12">                                        
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_insertar"><i class="mdi mdi-plus"></i> Asignar</button>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_table_asign as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('Asignacion/edit'); ?>/<?php echo $row->asignacion_id; ?>"><span class="fas fa-edit" aria-hidden="true"></span></a>   
                                                         <a href="<?php echo site_url('activos/pdf_asign'); ?>/<?php echo $row->activo_id  ?>" target="_blank"><span class="fas fa-file-pdf" aria-hidden="true" style="color:red"></span></a>                                                      
