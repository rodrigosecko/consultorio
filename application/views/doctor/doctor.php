                    ...
                    <div class="card-body">
                        <div class="row page-titles">
                            <div class="col-md-6 col-8 align-self-center">
                                <h4 class="card-title">Registro Doctor</h4>                                
                            </div>                           
                        </div>                       
                        <p></p>                       
                        <!-- Step 1 -->                         
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="auxiliar_table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php $i=1;?>
                                            <?php foreach ($data_table_doctor as $row) {
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                       <button  type="button" class="btn btn-warning footable-edit" data-toggle="modal" data-target="#modalEdicion" onclick="agregarform('<?php echo $datos ?>')">
                                                        ...
                                                        <a href="<?php echo site_url('doctor/delete'); ?>/<?php echo $row->id_doctor; ?>"><span class="far fa-trash-alt" aria-hidden="true" style="color:#82b94a"></span> </a>
                                                </td>
                                            </tr>
                                            <?php 
                                        } ?>
                    ...
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo form_open('doctor/create', array('method'=>'POST')); ?>                                       
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">                                
                                    ...
                                    <div class="col-md-4">
                                         <div class="form-group">
                                              <label for="recipient-name" class="control-label">Especialdad</label>
                                <select class="select2" style="width: 100%" name="id_especialidad" id="id_especialidad">
                                    <option>Seleccionar cargo</option>
                                    <?php foreach($especialidades as $clista){ ?>
                                        <option value="<?php echo $clista->id_especialidad; ?>"><?php echo $clista->descripcion; ?></option>
                                    <?php } ?>
                                </select>
                ...
                <div class="modal fade bs-example-modal-lg" id="modalEdicion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                    <div class="modal-dialog modal-xl" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <?php echo form_open('doctor/update', array('method'=>'POST')); ?>                                       
                                <div class="row">
                                      <input type="hidden" class="form-control" id="id_doctor_e" name="id_doctor_e" required="">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                   <label for="recipient-name" class="control-label">Nombre:</label>
                                    ...
                                    <div class="col-md-4">
                                         <div class="form-group">
                                                   <label for="recipient-name" class="control-label">Especialidad:</label>
                                                    <select class="select2" style="width: 100%" name="id_especialidad_e" id="id_especialidad_e">
                                    <option>Seleccionar cargo</option>
                                    <?php foreach($especialidades as $clista){ ?>
                                        <option value="<?php echo $clista->id_especialidad; ?>"><?php echo $clista->descripcion; ?></option>
                                    <?php } ?>
