                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($data_table_cargo as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('cargos/edit'); ?>/<?php echo $row->cargo_id; ?>"><button type="button" class="btn btn-warning"><span class="fas fa-edit" aria-hidden="true"></span></button></a>
                                                     

                                                        <?php if (($row->activo)==1):?>
                                                            <a href="<?php echo site_url('cargos/delete'); ?>/<?php echo $row->cargo_id; ?>"><button type="button" class="btn btn-danger"><span class="fas fa-arrow-alt-circle-down" aria-hidden="true"></span> Dar de Baja</button></a>
                                                        <?php endif ?>
                                                        <?php if (($row->activo)==0):?>
                                                            <a href="<?php echo site_url('cargos/delete'); ?>/<?php echo $row->cargo_id; ?>"><button type="button" class="btn btn-success"><span class="fas fa-arrow-alt-circle-up" aria-hidden="true"></span> Dar de Alta</button></a>
                                                        <?php endif ?>
